...
default_args = {
    'owner':'Manikyala Rao Cherukuri',
    'start_date': days_ago(0),
    'email': ['manikyam.cherukuri1@gmail.com'],
...
transform_data = BashOperator(
    ...
    bash_command='grep -v ' + '\'^198\.46\.149\.143\'' + ' \
        /home/project/airflow/dags/capstone/extracted-data.txt > /home/project/airflow/dags/capstone/transformed-data.csv',
    dag=dag,
)
