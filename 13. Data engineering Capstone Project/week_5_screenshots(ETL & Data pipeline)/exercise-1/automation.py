...
connection = mysql.connector.connect(user='root', password='MzEzMzktbWFuaWt5',host='127.0.0.1',database='sales')
...
dsn_uid = "hcl81797"        # e.g. "abc12345"
dsn_pwd = "8RQiXfIhMBF5pFfY"      # e.g. "7dBZ3wWt9XN6$o0J"
